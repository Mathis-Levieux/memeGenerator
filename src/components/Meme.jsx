...
// PENSER AUX LAZY FONCTIONS, POUR EVITER DE REINITIALISER INUTILEMENT LE USESTATE A CHAQUE FOIS, NOTAMMENT EN LOCALSTORAGE
// const [notes, setNotes] = React.useState(() =>
// JSON.parse(localStorage.getItem("notes")) || []
// )

// PENSER AU FIND ET AU FILTER

// function updateNote(text) {
//     setNotes(prevNotes => {
//       const updatedNote = { ...prevNotes.find(note => note.id === currentNoteId), body: text };
